...
public class DateUtils {
    ...
    private static final DateTimeFormatter FORMATTER_PT_BR = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm");
    ...
    public LocalDateTime stringToLocalDateTime(String localDateTime) {
        try {
            return LocalDateTime.parse(localDateTime, FORMATTER_PT_BR);
        } catch (Exception exception) {
            throw new BadRequestException(DETALHE_DATE_ERROR);
        }
    }
